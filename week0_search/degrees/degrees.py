...
def shortest_path(source, target):
    ...
    # TODO
    # To keep track of numer of stated explored
    num_explored = 0

    # Initialize frontier (starting point)
    ...
    while True:
        ...
        # (2) Remove node from frontier, this will be considered
        ...
        # (4.2) Mark node as explored, just add the states (actors)
        explored_set.add(node.state)

        # (4.1) Add neighbors to frontier (expand node)
        neighbors = neighbors_for_person(node.state)
        for movie, actor in neighbors:
            # if not in frontier nor in explored, add to frontier
